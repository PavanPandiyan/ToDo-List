...
function showItem() {
    ...
    <div class="todoList">
    <div class="todotext">
    <p class="pText">${data.task}</p>
    </div>
    <div class="buttons">
    <button onclick="AddRemainder(${data.time},${index});" class="btn1" >Add Reminder</button>
    <button onclick="start(${data.time},${index})" class="start" >Start</button>
